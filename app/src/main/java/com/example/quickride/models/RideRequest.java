...
public class RideRequest implements Cloneable {
    ...
    private String trustedDriverOnly;
    ...
    public String getTrustedDriverOnly() { return trustedDriverOnly; }
    public void setTrustedDriverOnly(String trustedDriverOnly) { this.trustedDriverOnly = trustedDriverOnly; }
    ...
    public void parseData(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.child("trustedDriverOnly").getValue() != null) {
            this.trustedDriverOnly = dataSnapshot.child("trustedDriverOnly").getValue().toString();
        }
