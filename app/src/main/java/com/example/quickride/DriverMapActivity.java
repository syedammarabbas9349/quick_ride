...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void getAssignedCustomerInfo() {
        ...
        driverDb.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.child("destination").getValue() != null){
                    mCustomerDestination.setText("Destination: " + dataSnapshot.child("destination").getValue().toString());
                }
            }
            @Override public void onCancelled(@NonNull DatabaseError error) {}
        });
        ...
        mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(map.get("name") != null) mCustomerName.setText(map.get("name").toString());
                    if(map.get("phone") != null) mCustomerPhone.setText(map.get("phone").toString());
    ...
    private void disconnectDriver() {
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            DatabaseReference refAvailable = FirebaseDatabase.getInstance().getReference("driversAvailable");
            DatabaseReference refWorking = FirebaseDatabase.getInstance().getReference("driversWorking");
            new GeoFire(refAvailable).removeLocation(userId);
    ...
    @Override protected void onStop() {
        super.onStop();
        if (!isLoggingOut) { disconnectDriver(); }
    }
